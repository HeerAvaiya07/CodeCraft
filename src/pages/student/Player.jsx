...
//               </div>
//             )
//             : <img src={courseData ? courseData.courseThumbnail : ''} alt="" style={{ height: '70%',marginLeft: '180px' }} />
//         }
//       </div>
//     </div>
//     <Footer />
                ...
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  >
                    ...
                    <p className="text-sm md:text-default">
                      ...
                      {parseFloat(calculateChapterTime(chapter)).toFixed(2)} minutes
                    </p>
                  </div>
                        ...
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className="flex gap-2">
                              ...
                              <p>{parseFloat(lecture.lectureDuration).toFixed(2)} minutes</p>
                            </div>
                          </div>
                        </li>
                      ))}
        ...
        <div className="md:mt-10">
          {playerData ? (
            ...
            <img
              ...
              alt=""
              style={{ height: '70%', marginLeft: '180px' }}
            />
          )}
        </div>
      </div>
